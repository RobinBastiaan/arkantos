...
class AdminProcess
{
   ...
   function procUpdateLevel(){
      ...
      /* Update user level */
         ...
         $database->updateUserField($subuser, "userlevel", (int)$_GET['updlevel']);
         header("Location: admin.php ");
      }
   }
   ...
   function procDeleteInactive(){
      ...
      $inact_time = $session->time - $_GET['inactdays']*24*60*60;
