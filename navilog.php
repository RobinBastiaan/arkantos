...
<table bgcolor="#FAFAD9" width="70%" border="1">
  <tr>
    <th scope="col"><a href="homelog.php" target="main">Start</a></th>
    <th scope="col"><a href="about.php" target="main">Over ons spel</a></th>
    <th scope="col"><a href="main.php" target="main">Je account</a></th>
   ...
   ?>
	...
	<th scope="col"><a href="stad.php" target="main">Toon Stad</a></th>
	<th scope="col"><a href="map.php" target="main">Toon Map</a></th>
	<?
	}
	?>
	<th scope="col"><a href="berichten.php" target="main">Je berichten</a></th>
    <th scope="col"><a href="ranglijst.php" target="main">Ranglijst</a></th>
  </tr>
</table>
</body>
</html>
